...
-- t_shopping_goods 테이블 goods_sale_price 10%할인 전체 적용
UPDATE T_SHOPPING_GOODS
SET GOODS_SALES_PRICE = GOODS_PRICE * 0.90
WHERE GOODS_SALES_PRICE != GOODS_PRICE * 0.90;
...
-- 공지사항 게시판
insert into t_shopping_news values (1, '공지사항 게시판 테스트1', '공지사항 게시판 테스트1 내용', '24/05/01', 0, '포토샵 무작정 따라하기_상세1.jpg', 'admin');
insert into t_shopping_news values (2, '공지사항 게시판 테스트2', '공지사항 게시판 테스트2 내용', '24/05/01', 0, 'detail3.jpg', 'admin');
insert into t_shopping_news values (3, '공지사항 게시판 테스트3', '공지사항 게시판 테스트3 내용', '24/05/01', 0, 'main_react.jpg', 'admin');

-- 리뷰 게시판 
insert into t_shopping_review values (1, '리뷰 게시판 테스트1', '리뷰 게시판 테스트1 내용', '24/05/01', 'lee', 339);
insert into t_shopping_review values (2, '리뷰 게시판 테스트2', '리뷰 게시판 테스트2 내용', '24/05/01', 'lee', 339);
insert into t_shopping_review values (3, '리뷰 게시판 테스트3', '리뷰 게시판 테스트3 내용', '24/05/01', 'lee', 339);

...
public interface CartController {
	...
	public @ResponseBody String addGoodsInCart(@RequestParam("goods_id") int goods_id,@RequestParam("cart_goods_id") int cart_goods_id, HttpServletRequest request, HttpServletResponse response)  throws Exception;

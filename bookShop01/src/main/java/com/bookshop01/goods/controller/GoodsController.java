...
public interface GoodsController  {
   ...
   public String goodsSortView(@RequestParam("goodsSort") String goodsSort, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception;
}
      ...
      <tbody align=center>
         ...
         <tr>
            <c:forEach var="item" items="${orderList }">
               ...
               <td><h2><fmt:formatNumber value="${item.order_goods_qty *item.goods_sales_price}" pattern="#,###" />원 (10% 할인)</h2></td>
               <td><h2>0원</h2></td>
               <td>
                 <h2><fmt:formatNumber value="${item.order_goods_qty *item.goods_sales_price}" pattern="#,###" />원</h2>
               </td>
         </tr>
         </c:forEach>
      </tbody>

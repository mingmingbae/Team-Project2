...
<body>
	<h3>필수입력사항</h3>
	<form action="${contextPath}/kakao/addKakaoJoin.do" method="post">	
	...
	<div id="detail_table">
		<table>
			<tbody>
				<tr class="dot_line">
					...
					<td>
					  <input type="text" name="member_id"  id="member_id" value="${memberInfo.member_id }" readonly />
					</td>
				</tr>
				<tr class="dot_line">
				...
				<tr class="dot_line">
					...
					<td>
						<input size="10px" type="text" name="email1" value="${memberInfo.email1}" readonly /> @ 
		...
		<tr >
			<td >
				<input type="submit"  value="추가 정보 저장">
